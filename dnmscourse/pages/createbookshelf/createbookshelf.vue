	...
	<ezpage :title="title">
		...
		<view slot="contentSection" style="padding:10px;">
			<view class="dnms-card">
				...
				<view class="dnms-divider" style="border: #C0C0C0 solid 1rpx;">
			...
			<view class="dnms-blockbutton" @click="btnSaveBookshelf">保存

			</view>
		</view>
		<!-- 		<view v-slot="tabSection">
		...
		methods: {
			...
			btnSaveBookshelf() {
				...
				cloudApi.call({
					name: "bookshelfs",
					data: {
						action: this._id ? "upadate" : "create",
						_id: this._id,
						name: this.name,
