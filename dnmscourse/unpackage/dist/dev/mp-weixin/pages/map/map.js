...
var _map = _interopRequireDefault(__webpack_require__(/*! ./pages/map/map.vue */ 35));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _map_vue_vue_type_template_id_0b31f540___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./map.vue?vue&type=template&id=0b31f540& */ 36);
/* harmony import */ var _map_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./map.vue?vue&type=script&lang=js& */ 38);
...
var _cloudApi = _interopRequireDefault(__webpack_require__(/*! ../../common/cloudApi.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var ezpage = function ezpage() {__webpack_require__.e(/*! require.ensure | components/ezpage */ "components/ezpage").then((function () {return resolve(__webpack_require__(/*! ../../components/ezpage.vue */ 52));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
{
  components: {
    ezpage: ezpage },
  ...
  methods: {
    // 区域拖动变更事件
    onRengionChanged: function onRengionChanged(e) {
      if (e.type === "end") {
